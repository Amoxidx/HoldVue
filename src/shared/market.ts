...
const LOCAL_CATALOG: readonly CatalogEntry[] = [
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'EUNL@XETRA', symbol: 'EUNL', name: 'iShares Core MSCI World UCITS ETF USD (Acc)', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['msci world', 'world etf'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'XDWD@XETRA', symbol: 'XDWD', name: 'Xtrackers MSCI World UCITS ETF 1C', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['msci world', 'world etf'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'SPPW@XETRA', symbol: 'SPPW', name: 'SPDR MSCI World UCITS ETF', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['msci world', 'world etf'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'VWCE@XETRA', symbol: 'VWCE', name: 'Vanguard FTSE All-World UCITS ETF USD Accumulating', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['all world', 'ftse world'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'SXR8@XETRA', symbol: 'SXR8', name: 'iShares Core S&P 500 UCITS ETF USD (Acc)', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['sp 500', 's&p 500'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'SXRV@XETRA', symbol: 'SXRV', name: 'iShares Nasdaq 100 UCITS ETF USD (Acc)', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['nasdaq 100'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'IUSN@XETRA', symbol: 'IUSN', name: 'iShares MSCI World Small Cap UCITS ETF', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['msci world small cap', 'small caps'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'IS3S@XETRA', symbol: 'IS3S', name: 'iShares Edge MSCI World Minimum Volatility UCITS ETF', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['msci world minimum volatility'] },
  { providerId: LOCAL_CATALOG_PROVIDER_ID, providerSymbol: 'XDWH@XETRA', symbol: 'XDWH', name: 'Xtrackers MSCI World Health Care UCITS ETF 1C', exchange: 'XETRA', currency: 'EUR', type: 'etf', aliases: ['healthcare etf', 'health care etf'] },
