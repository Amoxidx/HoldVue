...
const messages = {
  de: {
    ...
    'wallet.eyebrow': 'WALLETS / WALLET-QUELLEN', 'wallet.title': 'Wallets', 'wallet.copy': 'Verwalte öffentliche Adressen und Extended Public Keys. Synchronisierung bleibt providerabhängig; keine NFTs.', 'wallet.add': 'Wallet hinzufügen', 'wallet.empty': 'Noch keine Wallets verbunden.', 'wallet.etherscanTitle': 'ERC-20: kostenloser Etherscan-Key', 'wallet.etherscanHelp': 'Native EVM-Bestände funktionieren ohne Key. Für ERC-20-Token auf Etherscan-Chains ist ein kostenloser Etherscan-Key erforderlich.', 'wallet.etherscanAction': 'In Einstellungen',
  ...
  en: {
    ...
    'wallet.eyebrow': 'WALLETS / WALLET SOURCES', 'wallet.title': 'Wallets', 'wallet.copy': 'Manage public addresses and extended public keys. Synchronization depends on providers; no NFTs.', 'wallet.add': 'Add wallet', 'wallet.empty': 'No wallets connected yet.', 'wallet.etherscanTitle': 'ERC-20: free Etherscan key', 'wallet.etherscanHelp': 'Native EVM balances work without a key. ERC-20 discovery on Etherscan chains requires a free Etherscan key.', 'wallet.etherscanAction': 'Open Settings',
