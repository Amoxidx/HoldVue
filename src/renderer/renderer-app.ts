...
const messages = {
  de: {
    ...
    'wallet.eyebrow': 'WALLETS / WALLET-QUELLEN', 'wallet.title': 'Wallets', 'wallet.copy': 'Verwalte öffentliche Adressen und Extended Public Keys. Synchronisierung bleibt providerabhängig; keine NFTs.', 'wallet.add': 'Wallet hinzufügen', 'wallet.empty': 'Noch keine Wallets verbunden.', 'wallet.etherscanTitle': 'Optional: kostenloser Etherscan-Key', 'wallet.etherscanHelp': 'Verbessert bei EVM-Wallets die Erkennung nativer Bestände und fungibler Token. HoldVue funktioniert auch ohne Key.', 'wallet.etherscanAction': 'In Einstellungen',
  ...
  en: {
    ...
    'wallet.eyebrow': 'WALLETS / WALLET SOURCES', 'wallet.title': 'Wallets', 'wallet.copy': 'Manage public addresses and extended public keys. Synchronization depends on providers; no NFTs.', 'wallet.add': 'Add wallet', 'wallet.empty': 'No wallets connected yet.', 'wallet.etherscanTitle': 'Optional: free Etherscan key', 'wallet.etherscanHelp': 'Improves discovery of native balances and fungible tokens for EVM wallets. HoldVue also works without a key.', 'wallet.etherscanAction': 'Open Settings',
