...
HoldVue is local-first. The default build has no network provider enabled and
does not require a secret or API token at runtime. Keep provider credentials
